...
@dso_cache = dso_local local_unnamed_addr global [592 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 764350426, ; hash 0x2d8f0fda, from name: aot-uniunity5.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1262844159, ; hash 0x4b4578ff, from name: uniunity5
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-uniunity5.dll.so
		ptr null; void* handle (0x0)
	}, ; 155
	...
	%struct.DSOCacheEntry {
		i64 1533694676, ; hash 0x5b6a52d4, from name: libaot-uniunity5
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-uniunity5.dll.so
		ptr null; void* handle (0x0)
	}, ; 204
	...
	%struct.DSOCacheEntry {
		i64 1962980387, ; hash 0x7500b423, from name: aot-uniunity5
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-uniunity5.dll.so
		ptr null; void* handle (0x0)
	}, ; 257
	...
	%struct.DSOCacheEntry {
		i64 3244433783, ; hash 0xc1622177, from name: uniunity5.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-uniunity5.dll.so
		ptr null; void* handle (0x0)
	}, ; 454
	...
	%struct.DSOCacheEntry {
		i64 3635103026, ; hash 0xd8ab4532, from name: libaot-uniunity5.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-uniunity5.dll.so
		ptr null; void* handle (0x0)
	}, ; 501
