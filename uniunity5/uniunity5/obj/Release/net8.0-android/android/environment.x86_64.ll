...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 592, ; uint32_t number_of_dso_cache_entries (0x250)
	i32 33555167, ; uint32_t android_runtime_jnienv_class_token (0x20002df)
	i32 100670995, ; uint32_t jnienv_initialize_method_token (0x6001e13)
	i32 100670994, ; uint32_t jnienv_registerjninatives_method_token (0x6001e12)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [592 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.26_name, ; name: libaot-Plugin.Maui.Calendar.dll.so
		ptr null; void* handle (0x0)
	}, ; 2
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.59_name, ; name: libaot-Xamarin.Google.Crypto.Tink.Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 16
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 523443179754456439, ; hash 0x743a4cc755d8577, from name: libaot-uniunity5.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-uniunity5.dll.so
		ptr null; void* handle (0x0)
	}, ; 19
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.96_name, ; name: libaot-netstandard.dll.so
		ptr null; void* handle (0x0)
	}, ; 41
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1896489598977065306, ; hash 0x1a51af3e0340415a, from name: uniunity5.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-uniunity5.dll.so
		ptr null; void* handle (0x0)
	}, ; 57
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.54_name, ; name: libaot-Xamarin.AndroidX.Security.SecurityCrypto.dll.so
		ptr null; void* handle (0x0)
	}, ; 58
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3272567489242304821, ; hash 0x2d6a7ecaebc79135, from name: aot-uniunity5
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-uniunity5.dll.so
		ptr null; void* handle (0x0)
	}, ; 109
	...
	%struct.DSOCacheEntry {
		i64 7299868196653446464, ; hash 0x654e5772d0b33540, from name: libaot-uniunity5
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-uniunity5.dll.so
		ptr null; void* handle (0x0)
	}, ; 217
	...
	%struct.DSOCacheEntry {
		i64 8914352074197278582, ; hash 0x7bb623fb314b9f76, from name: aot-uniunity5.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-uniunity5.dll.so
		ptr null; void* handle (0x0)
	}, ; 285
	...
	%struct.DSOCacheEntry {
		i64 14681110065883646267, ; hash 0xcbbdc7d23168093b, from name: uniunity5
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-uniunity5.dll.so
		ptr null; void* handle (0x0)
	}, ; 470
...
@.env.3 = private unnamed_addr constant [37 x i8] c"55eb0591-65f0-45c4-939b-cbda94155ff7\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [26 x i8] c"com.companyname.uniunity5\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [24 x i8] c"libaot-uniunity5.dll.so\00", align 16
...
@.DSOCacheEntry.26_name = private unnamed_addr constant [35 x i8] c"libaot-Plugin.Maui.Calendar.dll.so\00", align 16
...
@.DSOCacheEntry.54_name = private unnamed_addr constant [55 x i8] c"libaot-Xamarin.AndroidX.Security.SecurityCrypto.dll.so\00", align 16
...
@.DSOCacheEntry.59_name = private unnamed_addr constant [49 x i8] c"libaot-Xamarin.Google.Crypto.Tink.Android.dll.so\00", align 16
...
@.DSOCacheEntry.96_name = private unnamed_addr constant [26 x i8] c"libaot-netstandard.dll.so\00", align 16
